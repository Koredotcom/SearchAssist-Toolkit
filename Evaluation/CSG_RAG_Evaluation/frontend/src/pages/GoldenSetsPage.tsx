...
import type { GoldenSet, TestCase, MatchSpecRule } from "@/lib/api";
import {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div>
                ...
                {tc.reference_doc_ids.length > 0 && (
                  <>
                    <p className="font-medium text-gray-600 mt-3 mb-1">Reference Doc IDs</p>
                ...
                {tc.reference_match_spec.length > 0 && (
                  <>
                    <p className="font-medium text-gray-600 mt-3 mb-1">Assertion Target</p>
                    <div className="flex flex-wrap gap-1">
                      {tc.reference_match_spec.map((rule: MatchSpecRule, i: number) => (
                        <span key={i} className="px-2 py-0.5 bg-violet-50 text-violet-700 rounded font-mono text-[11px]">
