...
CREATE TABLE IF NOT EXISTS app_config (
    ...
    -- New Kore.ai Agent Platform API fields
    process_id      TEXT NOT NULL DEFAULT '',   -- a-xxxxxxxx (appId / processId)
    cf_version_id   TEXT NOT NULL DEFAULT '',   -- cf-xxxxxxxx (version ID)
    x_api_key       TEXT NOT NULL DEFAULT '',   -- kg-xxxxxxxx API key
    identity        TEXT NOT NULL DEFAULT '',   -- RACL user identity (user@domain)
    sources         TEXT NOT NULL DEFAULT '',   -- source filter (empty = all)
